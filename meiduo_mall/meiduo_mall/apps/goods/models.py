...
class GoodsCategory(BaseModel):
    ...
    parent = models.ForeignKey('self', null=True, blank=True, on_delete=models.CASCADE, verbose_name="父类别名称")
...
class Goods(BaseModel):
    ...
    desc_pack = RichTextField(default='', verbose_name='包装信息')  # 该方法不能上传图片
